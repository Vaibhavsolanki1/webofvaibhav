...
const ShaderBackground: React.FC<ShaderBackgroundProps> = ({ theme = 'dark' }) => {
  ...
  // Fragment shader source code - parameterized for both themes
  ...
  useEffect(() => {
    ...
    const shaderProgram = initShaderProgram(gl, vsSource, getFragmentShader(isDark));
